...
function Hotels({ trip }) {
  ...
  console.log("Hotels array:", tripData?.hotels); // Debug: Check hotels array
  ...
  return (
    <div>
      <div className="font-bold text-xl mt-5 my-4">Hotel Recommendations</div>
            ...
            <div key={index} className="hover:scale-105 cursor-pointer transition-all">
              ...
              <div className="p-4 bg-white rounded-b-xl">
                <div className="flex justify-between items-start">
                  ...
                  <Link to={hotel.locationMap} key={index}>
                    <Button className="text-white">
                      <FaMapMarkedAlt />
                    </Button>
                  </Link>
                </div>
                <h2 className="text-xs text-gray-500 my-1">📍 {hotel.address || "Address not available"}</h2>
